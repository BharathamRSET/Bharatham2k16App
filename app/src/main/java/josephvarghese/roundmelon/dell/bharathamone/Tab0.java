...
public class Tab0 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView1 =  inflater.inflate(R.layout.fragment_tab1, container, false);
    ...
    private class DownloadData extends AsyncTask<String,Void,String> {
        ...
        protected void onPostExecute(String result) {
            ...
            ArrayAdapter<josephvarghese.roundmelon.dell.bharathamone.Application> arrayAdapter = new ArrayAdapter<josephvarghese.roundmelon.dell.bharathamone.Application>(
